...
#ifndef LEETCODE_OPTIMAL_SOLUTIONS_2269_找到一个数字的_K_美丽值_H
#define LEETCODE_OPTIMAL_SOLUTIONS_2269_找到一个数字的_K_美丽值_H
...
#endif //LEETCODE_OPTIMAL_SOLUTIONS_2269_找到一个数字的_K_美丽值_H
